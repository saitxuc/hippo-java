 ...
 */
package com.hippo.leveldb.benchmark;

import static com.google.common.base.Charsets.UTF_8;
import static com.hippo.leveldb.benchmark.DbBenchmark.DBState.EXISTING;
import static com.hippo.leveldb.benchmark.DbBenchmark.DBState.FRESH;
import static com.hippo.leveldb.benchmark.DbBenchmark.Order.RANDOM;
import static com.hippo.leveldb.benchmark.DbBenchmark.Order.SEQUENTIAL;
...
import com.hippo.leveldb.DBIterator;
import com.hippo.leveldb.Options;
import com.hippo.leveldb.WriteBatch;
import com.hippo.leveldb.WriteOptions;
import com.hippo.leveldb.impl.DbImpl;
import com.hippo.leveldb.util.Closeables;
import com.hippo.leveldb.util.FileUtils;
import com.hippo.leveldb.util.PureJavaCrc32C;
...
public class DbBenchmark
{
    ...
    public DbBenchmark(Map<Flag, Object> flags) throws Exception
    {
        ...
        factory = (DBFactory) cl.loadClass(System.getProperty("leveldb.factory", "com.hippo.leveldb.bucket.DdbFactory")).newInstance();
