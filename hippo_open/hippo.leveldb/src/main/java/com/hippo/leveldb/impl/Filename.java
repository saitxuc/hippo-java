...
public class Filename
{
    ...
    * 
    */
    public static String bucketOfLevelFileName(long number)
    {
        return makeFileName(number, "bkl");
    }
    ...
    public static FileInfo parseFileName(File file)
    {
        ...
        else if (fileName.endsWith(".bkl")) {
            long fileNumber = Long.parseLong(removeSuffix(fileName, ".bkl"));
            return new FileInfo(FileType.BUCKET_OF_LEVEL, fileNumber);
        }
        else if (fileName.endsWith(".bk")) {
            long fileNumber = Long.parseLong(removeSuffix(fileName, ".bk"));
            return new FileInfo(FileType.BUCKET, fileNumber);
        }
        return null;
    }
