...
public class FileMetaData {
	...
	public FileMetaData(long number, long fileSize, InternalKey smallest, InternalKey largest, Set<Integer> buckets) {
		this.number = number;
		this.fileSize = fileSize;
		this.smallest = smallest.simplify();
		this.largest = largest.simplify();
	...
	public String toString() {
		...
		sb.append(", buckets=").append(buckets == null ? 0 : buckets.size());
