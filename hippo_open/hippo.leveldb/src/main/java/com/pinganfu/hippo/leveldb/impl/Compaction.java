...
public class Compaction
{
    ...
    private Entry<InternalKey, InternalKey> keyRange;
    ...
    public Entry<InternalKey, InternalKey> getKeyRange() {
		return keyRange;
	}



	public Compaction setKeyRange(Entry<InternalKey, InternalKey> keyRange) {
