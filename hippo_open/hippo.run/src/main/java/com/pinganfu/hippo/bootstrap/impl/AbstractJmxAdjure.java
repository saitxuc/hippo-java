 ...
 * 2015-3-20
 */
public abstract class AbstractJmxAdjure extends AbstractAdjure {
    ...
    static {
        DEFAULT_JMX_URL = System.getProperty("hippo.jmx.url", "service:jmx:rmi:///jndi/rmi://localhost:31099/jmxrmi");
        jmxUser = System.getProperty("hippo.jmx.user");
        jmxPassword = System.getProperty("hippo.jmx.password");
    }
            ...
            if (isSunJVM()) {
                try {
                    ...
                    for(Object vmInstance : allVMs) {
                        ...
                        if (displayName.contains("hippo.jar start")) {
                            String id = (String)getVMId.invoke(vmInstance, (Object[])null);
    ...
    public void setJmxUser(String jmxUser) {
    	AbstractJmxAdjure.jmxUser = jmxUser;
    }
    ...
    public void setJmxPassword(String jmxPassword) {
    	AbstractJmxAdjure.jmxPassword = jmxPassword;
    }
