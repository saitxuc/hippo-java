...
import com.hippo.common.exception.ConfigurationException;
...
import com.hippo.common.util.URISupport.CompositeData;
...
import com.hippo.network.exception.TransportException;
...
public class TransportConnectionFactory implements ConnectionFactory {
    ...
    private TransportConnection createHippoConnection(Transport transport) throws Exception {
        TransportConnection connection = new NettyConnection(transport, getClientIdGenerator(), getConnectionIdGenerator());
        return connection;
    }
