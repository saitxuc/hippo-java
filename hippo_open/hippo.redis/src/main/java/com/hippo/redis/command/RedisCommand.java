...
public class RedisCommand extends Command{
	...
	public static final byte[] ARGS_PREFIX = "*".getBytes();
	  ...
	  public RedisCommand(Object[] objects, boolean inline) {
	    this(null, null, null, null, objects, inline);
	  }

	  public RedisCommand(Object name) {
	    this(name, null, null, null, null, false);
	  }

	  public RedisCommand(Object name, Object[] objects) {
	    this(name, null, null, null, objects, false);
	  }

	  public RedisCommand(Object name, Object object1) {
	    this(name, object1, null, null, null, false);
	  }

	  public RedisCommand(Object name, Object object1, Object object2) {
	    this(name, object1, object2, null, null, false);
	  }

	  public RedisCommand(Object name, Object object1, Object object2, Object object3) {
	    this(name, object1, object2, object3, null, false);
	  }

	  private RedisCommand(Object name, Object object1, Object object2, Object object3, Object[] objects, boolean inline) {
	    this.name = name;
