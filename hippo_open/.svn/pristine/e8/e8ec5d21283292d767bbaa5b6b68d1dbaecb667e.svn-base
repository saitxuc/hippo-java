 ...
 */
package com.pinganfu.hippo.leveldb.benchmark;

import static com.google.common.base.Charsets.UTF_8;
import static com.pinganfu.hippo.leveldb.benchmark.DbBenchmark.DBState.EXISTING;
import static com.pinganfu.hippo.leveldb.benchmark.DbBenchmark.DBState.FRESH;
import static com.pinganfu.hippo.leveldb.benchmark.DbBenchmark.Order.RANDOM;
import static com.pinganfu.hippo.leveldb.benchmark.DbBenchmark.Order.SEQUENTIAL;
...
import com.pinganfu.hippo.leveldb.DBFactory;
import com.pinganfu.hippo.leveldb.DBIterator;
...
import com.pinganfu.hippo.leveldb.util.Closeables;
import com.pinganfu.hippo.leveldb.util.FileUtils;
import com.pinganfu.hippo.leveldb.util.PureJavaCrc32C;
...
public class DbBenchmark
{
    ...
    public DbBenchmark(Map<Flag, Object> flags) throws Exception
    {
        ...
        factory = (DBFactory) cl.loadClass(System.getProperty("leveldb.factory", "com.pinganfu.hippo.leveldb.bucket.DdbFactory")).newInstance();
