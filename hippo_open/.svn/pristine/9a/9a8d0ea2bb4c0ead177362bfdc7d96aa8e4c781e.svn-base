...
import static com.pinganfu.hippo.leveldb.CompressionType.NONE;
import static com.pinganfu.hippo.leveldb.impl.DbConstants.NUM_LEVELS;
import static com.pinganfu.hippo.leveldb.table.BlockHelper.afterString;
import static com.pinganfu.hippo.leveldb.table.BlockHelper.assertSequence;
import static com.pinganfu.hippo.leveldb.table.BlockHelper.beforeString;
...
public class DbImplTest
{
    ...
    public static final double STRESS_FACTOR = Double.parseDouble(System.getProperty("STRESS_FACTOR", "5"));
    ...
    protected class DbStringWrapper
    {
        private final Options options;
        private final File databaseDir;
        private DbImpl db;

        public DbStringWrapper(Options options, File databaseDir)
                throws IOException
        {
