...
public class ServerInfoBean implements Serializable{
	...
	public String getOld_server_id() {
		return old_server_id;
	}
	public void setOld_server_id(String old_server_id) {
		this.old_server_id = old_server_id;
	}
	public long getId() {
		return id;
	}
