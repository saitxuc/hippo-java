package com.pinganfu.hippo.bootstrap;
 ...
 */
public class Main {
	public static final String TASK_DEFAULT_CLASS = "com.pinganfu.hippo.bootstrap.impl.ShellAdjure";
    ...
    public File getHippoHome() {
        if (hippoHome == null) {
            ...
            if (hippoHome == null) {
                ...
                URL url = Main.class.getClassLoader().getResource("com/pinganfu/hippo/bootstrap/Main.class");
                if (url != null) {
                    try {
