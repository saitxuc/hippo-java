...
import static com.pinganfu.hippo.leveldb.util.VariableLengthQuantity.readVariableLengthInt;
import static com.pinganfu.hippo.leveldb.util.VariableLengthQuantity.writeVariableLengthInt;
