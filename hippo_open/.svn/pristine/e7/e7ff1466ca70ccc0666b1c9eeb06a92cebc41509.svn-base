...
import static com.pinganfu.hippo.leveldb.table.BlockHandle.readBlockHandle;
import static com.pinganfu.hippo.leveldb.table.BlockHandle.writeBlockHandleTo;
